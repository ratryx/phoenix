...
def test_hardware_service_dynamic_capabilities():
    ...
    # 1. GPUs existem
    with patch("modules.core.gpu_metrics.obter_metricas_gpu", return_value=[{"id": "GPU1"}]):
    ...
    # 3. Falha no gpu_metrics
    with patch("modules.core.gpu_metrics.obter_metricas_gpu", side_effect=Exception("Fail")):
    ...
    # 4. Confirme que o dicionario original injetado continua sem capacidades dinamicas
    # O HardwareService deve operar em uma copia.
